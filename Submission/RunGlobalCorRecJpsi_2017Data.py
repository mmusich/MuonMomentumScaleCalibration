...
process = cms.Process('RECO2',Run2_2017)
...
process.GlobalTag.toGet = cms.VPSet(
  cms.PSet(record = cms.string("GeometryFileRcd"),
           tag = cms.string("XMLFILE_Geometry_92YV5_Extended2017Plan1_mc"),
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        'root://cms-xrd-global.cern.ch//store/data/Run2017C/Charmonium/ALCARECO/TkAlJpsiMuMu-09Aug2019_UL2017-v1/30000/75D25D00-C0B4-7140-88BC-EA37D0DF6BB3.root',
    ),
    secondaryFileNames = cms.untracked.vstring(),
)
...
process.globalCor = cms.EDProducer('ResidualGlobalCorrectionMakerTwoTrackG4e',
                                   ...
                                   #jpsi triggers (Charmonium PD, 2017, got them from https://cmshltinfo.app.cern.ch/summary)
                                   triggers = cms.vstring(["HLT_DoubleMu4_3_Bs",
                                                           "HLT_DoubleMu4_3_Jpsi_Displaced",
                                                           "HLT_DoubleMu4_JpsiTrk_Displaced",
                                                           "HLT_DoubleMu4_PsiPrimeTrk_Displaced",
